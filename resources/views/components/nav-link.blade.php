...
$classes = ($active ?? false)
            ? 'inline-flex  items-center px-1 py-2 text-4xl font-medium leading-5 text-gray-100 dark:text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
