...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 opacity-100 z-0 
            ...
            <!-- Page Heading -->
            @if (isset($header))
                <header class="bg-white dark:bg-purple-800 opacity-50 shadow">
            ...
            <footer class="bg-gray-900">
                <div class="flex-col">
                    <div class="flex justify-center items-center text-gray-500 py-2 font-bold">
                        <h2 class="">
                            Contactos
                        </h2>
                    </div>
            
                    <div class="grid grid-cols-4 md:mx-96 md:px-60 mx-40">
                        <a href="https://wa.me/+50259770234?text=Hola">
                            <div class="flex items-center justify-center md:col-span-1 dark:text-white">
