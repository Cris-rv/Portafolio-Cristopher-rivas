<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full bg-slate-800 dark:bg-gray-800 border-b border-gray-400 dark:border-gray-700 text-gray-100 z-50 md:px-24">
